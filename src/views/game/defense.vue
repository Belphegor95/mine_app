    ...
    <ul v-else class="contentList">
      <li v-for="(ito,index)  in itolist" :key="index" @click="onito(ito)">
        <span>
          ...
          <img v-else-if="ito.name == '警犬'" src="../../assets/img/game/dog.png" alt />
          <img v-else-if="ito.name == '保安'" src="../../assets/img/game/man.png" alt />
          <img v-else-if="ito.name == '金钟罩'" src="../../assets/img/game/dun.png" alt />
        </span>
        <div>
          <p>等级：{{ ito.name }}</p>
          <p>防御：{{ ito.prevent }}</p>
